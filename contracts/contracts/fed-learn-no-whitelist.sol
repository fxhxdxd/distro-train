...
/**
 * @title FederatedTrainingReward (No Whitelist Version)
 * @notice This version removes the whitelist requirement to allow open participation
 * @dev Use this for testing/development. For production, implement proper access control.
 */
contract FederatedTrainingReward {
    ...
    /// @dev ⚠️ WARNING: No whitelist check - anyone can submit weights in this version
    ...
    function submitWeights(
        ...
        // ✅ WHITELIST CHECK REMOVED - Open participation enabled
