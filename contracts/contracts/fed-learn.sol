...
contract FederatedTrainingReward {
    ...
    /// @notice Trainer submits final weights (Akave hash only) for a task and claims the per-chunk reward.
    /// @dev ⚠️ WARNING: Whitelist removed - open participation enabled for testing
    ...
    /// @param weightsHash Akave hash of the published weights (extracted from presigned URL)
